...
gnuplot gif_solution_exact_2D.txt
...
convert -delay 1 -loop 0 group1/exact_2D_*.png group1.gif
convert -delay 1 -loop 0 group2/exact_2D_*.png group2.gif
convert -delay 1 -loop 0 group3/exact_2D_*.png group3.gif

# Combinaison des GIF en un seul
gifsicle --merge group1.gif group2.gif group3.gif > /home/segal/Documents/MatMeca/TER-2A/Solutions/gif/exact_2D.gif
