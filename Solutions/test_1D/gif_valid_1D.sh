...
gnuplot gif_solution_valid_1D.txt
...
convert -delay 1 -loop 0 group1/valid_1D_*.png group1.gif
convert -delay 1 -loop 0 group2/valid_1D_*.png group2.gif
convert -delay 1 -loop 0 group3/valid_1D_*.png group3.gif

# Combinaison des GIF en un seul
gifsicle --merge group1.gif group2.gif group3.gif > /home/segal/Documents/MatMeca/TER-2A/Solutions/gif/valid_1D.gif

# Supprimer les répertoires temporaires
rm -r group1 group2 group3
rm -f group1.gif group2.gif group3.gif
rm -f validation_1D/*.png
